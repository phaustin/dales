...
SAVE
  ...
  integer, parameter:: mpatch                      = 200 !<  Maximum amount of patches that can be defined in each direction
  !integer, parameter:: mpatch                      = 80 !<  Maximum amount of patches that can be defined in each direction
